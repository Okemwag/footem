defmodule Footem.SportsTest do
  ...
  describe "games" do
    ...
    test "create_game/1 with valid data creates a game" do
      valid_attrs = %{status: "some status", sport_type: "some sport_type", home_team: "some home_team", away_team: "some away_team", start_time: ~U[2024-12-09 11:05:00Z], home_team_odds: "120.5", away_team_odds: "120.5", draw_odds: "120.5"}
      ...
      assert game.home_team == "some home_team"
      assert game.away_team == "some away_team"
      assert game.start_time == ~U[2024-12-09 11:05:00Z]
      assert game.home_team_odds == Decimal.new("120.5")
      assert game.away_team_odds == Decimal.new("120.5")
      assert game.draw_odds == Decimal.new("120.5")
    end
    ...
    test "update_game/2 with valid data updates the game" do
      game = game_fixture()
      update_attrs = %{status: "some updated status", sport_type: "some updated sport_type", home_team: "some updated home_team", away_team: "some updated away_team", start_time: ~U[2024-12-10 11:05:00Z], home_team_odds: "456.7", away_team_odds: "456.7", draw_odds: "456.7"}
      ...
      assert game.home_team == "some updated home_team"
      assert game.away_team == "some updated away_team"
      assert game.start_time == ~U[2024-12-10 11:05:00Z]
      assert game.home_team_odds == Decimal.new("456.7")
      assert game.away_team_odds == Decimal.new("456.7")
      assert game.draw_odds == Decimal.new("456.7")
    end
