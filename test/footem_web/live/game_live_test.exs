defmodule FootemWeb.GameLiveTest do
  ...
  @create_attrs %{status: "some status", sport_type: "some sport_type", home_team: "some home_team", away_team: "some away_team", start_time: "2024-12-09T11:05:00Z", home_team_odds: "120.5", away_team_odds: "120.5", draw_odds: "120.5"}
  @update_attrs %{status: "some updated status", sport_type: "some updated sport_type", home_team: "some updated home_team", away_team: "some updated away_team", start_time: "2024-12-10T11:05:00Z", home_team_odds: "456.7", away_team_odds: "456.7", draw_odds: "456.7"}
